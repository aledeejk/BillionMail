...
CREATE INDEX IF NOT EXISTS idx_workflow_execution_contact_id ON workflow_execution(contact_id);
...
CREATE INDEX IF NOT EXISTS idx_workflow_log_created_at ON workflow_log(created_at);
